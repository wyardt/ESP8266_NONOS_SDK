...
/***********************************************************************************************************************/
#define CFG_HOLDER    0x00FF55A5    /* Change this value to load default configurations original is 0x00FF55A4 */

/*DEFAULT CONFIGURATIONS*/

#define MQTT_HOST            "192.168.2.114" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            61613    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "8266"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define MQTT_PASS            "password" // you MQTT login password, same as above
#define STA_SSID "Kestrel's Router"    // your AP/router SSID to config your device networking
#define STA_PASS "15920143096a" // your AP/router password
